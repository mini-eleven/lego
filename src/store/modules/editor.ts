...
const testComponents: ComponentData[] = [
    { id: uuidv4(), name: 'l-text', props: { text: 'hello', fontSize: '20px', color: '#000000', lineHeight: 1, textAlign: 'left', fontFamily: '', opacity: '100' } },
...
const editor: Module<EditorProps, GlobalDataProps> = {
    ...
    mutations: {
        ...
        updateComponent(state, { key, value }) {
            const updatedComponent = state.components.find(x => x.id == state.currentElement)
            if (updatedComponent) {
